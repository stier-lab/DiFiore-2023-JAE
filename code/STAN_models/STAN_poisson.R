sink("code/STAN_models/allometric_poisson.stan")
cat("
    data {
    int N;
...
stanfit_gauss <- sampling(gauss_model, data = stan_data, chains = 4, thin = 3,
                          iter = 25000,
                          seed = 123123, control = list(adapt_delta = 0.95))
