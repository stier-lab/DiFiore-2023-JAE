sink("code/STAN_models/allometric_noind.stan")
cat("
    data {
    int N;
...
gauss_model <- rstan::stan_model('code/STAN_models/allometric_noind.stan')
